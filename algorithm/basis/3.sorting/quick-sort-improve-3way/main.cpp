...
int main() {
    ...
    SortTestHelper::testSort("quickSortImproveRandomV2", quickSortImproveRandomV2, arr7, n);
    SortTestHelper::testSort("quickSortImprove3way", quickSortImprove3way, arr8, n);
    ...
    delete (arr7); // 因为 arr 开辟了一个数组空间，所以要在这里释放
    delete (arr8); // 因为 arr 开辟了一个数组空间，所以要在这里释放
    return 0;
}