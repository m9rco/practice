...
int main() {
    ...
    int *ra3 = Tools::copyIntArray(ra0, n);
    ...
    testSort("InsertionSortImprove", InsertionSort::ascSortImprove, ra3, n);
    ...
    int *oa3 = Tools::copyIntArray(oa0, n);
    ...
    testSort("InsertionSortImprove", InsertionSort::ascSortImprove, oa3, n);
}